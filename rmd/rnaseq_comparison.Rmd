...
Beginner note: The next code chunk (`setup`) prepares data or visuals for this section; you don't need to edit it unless you want to change how the analysis runs.
...
Beginner note: The next code chunk (`packages`) prepares data or visuals for this section; you don't need to edit it unless you want to change how the analysis runs.
```{r packages}
library("openxlsx")
library("DT")
...
Beginner note: The next code chunk (`functions`) prepares data or visuals for this section; you don't need to edit it unless you want to change how the analysis runs.
```{r functions}
...
Beginner note: The next code chunk (`transform-data`) prepares data or visuals for this section; you don't need to edit it unless you want to change how the analysis runs.
```{r transform-data}
cat("R getwd(): ", getwd(), "\n")
...
Beginner note: The next code chunk (`DESeq2`) prepares data or visuals for this section; you don't need to edit it unless you want to change how the analysis runs.
```{r DESeq2}
...
Beginner note: The next code chunk (`entrezid`) prepares data or visuals for this section; you don't need to edit it unless you want to change how the analysis runs.
```{r entrezid}
gene.df <- bitr(
...
Beginner note: The next code chunk (`PCA`) prepares data or visuals for this section; you don't need to edit it unless you want to change how the analysis runs.
```{r PCA}
...
Beginner note: The next code chunk (`PCA-all-genes-without`) prepares data or visuals for this section; you don't need to edit it unless you want to change how the analysis runs.
...
Beginner note: The next code chunk (`PCA-all-genes-with`) prepares data or visuals for this section; you don't need to edit it unless you want to change how the analysis runs.
...
Beginner note: The next code chunk (`pheatmap-all-genes`) prepares data or visuals for this section; you don't need to edit it unless you want to change how the analysis runs.
...
Beginner note: The next code chunk (`PCA-top-500-without`) prepares data or visuals for this section; you don't need to edit it unless you want to change how the analysis runs.
...
Beginner note: The next code chunk (`PCA-top-500-with`) prepares data or visuals for this section; you don't need to edit it unless you want to change how the analysis runs.
```{r PCA-top-500-with}
...
Beginner note: The next code chunk (`pheatmap-top-500`) prepares data or visuals for this section; you don't need to edit it unless you want to change how the analysis runs.
```{r pheatmap-top-500}
mat <- assay(rld)
...
Beginner note: The next code chunk runs analysis code for this section; you don't need to edit it unless you want to change how the analysis runs.
```{r}
finalDE_VP <- finalDE
keyvals <- ifelse(
...
Beginner note: The next code chunk (`allgenes`) prepares data or visuals for this section; you don't need to edit it unless you want to change how the analysis runs.
```{r allgenes}
...
Beginner note: The next code chunk (`goccup`) prepares data or visuals for this section; you don't need to edit it unless you want to change how the analysis runs.
```{r goccup}
gocc_up <- enrichGO(
  gene = gene.df_up,
...
Beginner note: The next code chunk (`dotplotgocc`) prepares data or visuals for this section; you don't need to edit it unless you want to change how the analysis runs.
```{r dotplotgocc}
if (!is.null(gocc_up)) {
  if (test) {
...
Beginner note: The next code chunk (`cnetplotgocc`) prepares data or visuals for this section; you don't need to edit it unless you want to change how the analysis runs.
```{r cnetplotgocc}
if (!is.null(gocc_up)) {
  if (test) {
...
Beginner note: The next code chunk (`eval=FALSE`) prepares data or visuals for this section; you don't need to edit it unless you want to change how the analysis runs.
...
Beginner note: The next code chunk (`fig.width = 6`) prepares data or visuals for this section; you don't need to edit it unless you want to change how the analysis runs.
