...
group_a <- canonicalize_group("AllDiseases")
group_b <- canonicalize_group("WT")

info <- openxlsx::read.xlsx("data/RNAseq_proteomics_info.xlsx")
expr3_all <- expr3
...
design_formula <- "~ Reprogrammation + sex + condition2"
...
if (!is.null(gocc_up)) {
  test <- any(gocc_up@result$p.adjust < 0.2)
...
if (!is.null(gocc_down)) {
  test <- any(gocc_down@result$p.adjust < 0.2)
...
if (!is.null(gocc_all)) {
  test <- any(gocc_all@result$p.adjust < 0.2)
...
if (!is.null(gomf_up)) {
  test <- any(gomf_up@result$p.adjust < 0.2)
...
if (!is.null(gomf_down)) {
  test <- any(gomf_down@result$p.adjust < 0.2)
...
if (!is.null(gomf_all)) {
  test <- any(gomf_all@result$p.adjust < 0.2)
...
if (!is.null(gobp_up)) {
  test <- any(gobp_up@result$p.adjust < 0.2)
...
if (!is.null(gobp_down)) {
  test <- any(gobp_down@result$p.adjust < 0.2)
...
if (!is.null(gobp_all)) {
  test <- any(gobp_all@result$p.adjust < 0.2)
...
if (!is.null(egocc)) {
  test <- any(egocc@result$p.adjust < 0.2)
...
if (!is.null(egomf)) {
  test <- any(egomf@result$p.adjust < 0.2)
...
if (!is.null(egobp)) {
  test <- any(egobp@result$p.adjust < 0.2)
...
if (!is.null(kk_up)) {
  test <- any(kk_up@result$p.adjust < 0.2)
...
if (!is.null(kk_down)) {
  test <- any(kk_down@result$p.adjust < 0.2)
...
if (!is.null(kk_all)) {
  test <- any(kk_all@result$p.adjust < 0.2)
...
if (!is.null(kkg)) {
  test <- any(kkg@result$p.adjust < 0.2)
...
if (!is.null(wpres_up)) {
  test <- any(wpres_up@result$p.adjust < 0.2)
...
if (!is.null(wpres_down)) {
  test <- any(wpres_down@result$p.adjust < 0.2)
...
if (!is.null(wpres_all)) {
  test <- any(wpres_all@result$p.adjust < 0.2)
...
if (!is.null(wpresg)) {
  test <- any(wpresg@result$p.adjust < 0.2)
...
if (!is.null(reactome_up)) {
  test <- any(reactome_up@result$p.adjust < 0.2)
...
if (!is.null(reactome_down)) {
  test <- any(reactome_down@result$p.adjust < 0.2)
...
if (!is.null(reactome_all)) {
  test <- any(reactome_all@result$p.adjust < 0.2)
...
if (!is.null(reactome_gsea)) {
  test <- any(reactome_gsea@result$p.adjust < 0.2)
