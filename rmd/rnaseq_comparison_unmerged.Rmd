...
sink("log/deseq2_debug.txt")
cat("### DESIGN\n"); print(design(dds))
cat("\n### condition2 class\n"); print(class(colData(dds)$condition2))
cat("\n### condition2 table\n"); print(table(colData(dds)$condition2, useNA="ifany"))
cat("\n### condition2 levels\n"); print(levels(factor(colData(dds)$condition2)))
cat("\n### group_a / group_b\n"); print(params$group_a); print(params$group_b)
sink()
